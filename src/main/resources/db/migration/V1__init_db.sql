...
CREATE TABLE PUBLIC.FACULTY_USER_SUBJECT
(
    FACULTY_ID INT,
    USER_ID    INT,
    SUBJECT_ID INT
...
CREATE TABLE PUBLIC.FACULTIES_STATEMENTS
(
    FACULTY_ID INT,
    STATEMENT_ID INT
);

ALTER TABLE PUBLIC.FACULTIES_STATEMENTS
...
ALTER TABLE PUBLIC.ROLES_USERS
    ADD FOREIGN KEY (ROLE_ID) REFERENCES PUBLIC.ROLES (ROLE_ID);
...
ALTER TABLE PUBLIC.FACULTY_USER_SUBJECT
